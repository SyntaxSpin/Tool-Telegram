package dev.trindadedev.tooltelegram.ui.components
...
fun ApplicationScreen(
  ...
  val scrollBehaviorModifier =
    if (enableDefaultScrollBehavior) Modifier.nestedScroll(scrollBehavior.nestedScrollConnection)
    else Modifier
    ...
    Scaffold(
      ...
      content = { innerPadding ->
        ...
        if (columnContent) {
          Column(
            modifier =
              modifier.padding(top = innerPadding.calculateTopPadding()).then(scrollModifier),
